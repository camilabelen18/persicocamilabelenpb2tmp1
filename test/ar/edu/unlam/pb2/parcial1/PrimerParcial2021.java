...
class PrimerParcial2021 {
	...
	public void queSePuedaCrearUnaPelicula() {
		...
		// Validación
		assertEquals(CODIGO_ESPERADO, pelicula.getCodigoEsperado());
		assertEquals(DESCRIPCION_ESPERADA, pelicula.getDescripcionEsperada());
	...
	public void queSePuedaCrearUnVideojuego() {
		...
		// Validación
		assertEquals(CODIGO_ESPERADO, juego.getCodigoEsperado());
		assertEquals(DESCRIPCION_ESPERADA, juego.getDescripcionEsperada());
	...
	public void queSePuedaCrearUnLibro() {
		...
		// Validación
		assertEquals(CODIGO_ESPERADO, libro.getCodigoEsperado());
		assertEquals(DESCRIPCION_ESPERADA, libro.getDescripcionEsperada());
	...
	public void queSePuedaCrearUnComestible() {
		...
		// Validación
		assertEquals(CODIGO_ESPERADO, comestible.getCodigoEsperado());
		assertEquals(DESCRIPCION_ESPERADA, comestible.getDescripcionEsperada());
	}
